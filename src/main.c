...
static const vertex vertices[] = {
	...
	[ 3] = { { -0.5f, -0.5f, -0.5f }, {0.0f, 0.0f, 0.0f}, {0.50f, 0.50f} },
	[ 4] = { { -0.5f, +0.5f, +0.5f }, {0.0f, 0.0f, 0.0f}, {0.50f, 0.00f} },
	[ 5] = { { +0.5f, +0.5f, +0.5f }, {0.0f, 0.0f, 0.0f}, {0.75f, 0.00f} },
	[ 6] = { { +0.5f, -0.5f, +0.5f }, {0.0f, 0.0f, 0.0f}, {0.75f, 0.75f} },
	[ 7] = { { -0.5f, -0.5f, +0.5f }, {0.0f, 0.0f, 0.0f}, {0.50f, 0.75f} },
	[ 8] = { { +0.5f, -0.5f, +0.5f }, {0.0f, 0.0f, 0.0f}, {1.00f, 0.50f} },
	[ 9] = { { +0.5f, +0.5f, +0.5f }, {0.0f, 0.0f, 0.0f}, {1.00f, 0.25f} },
	[10] = { { -0.5f, +0.5f, +0.5f }, {0.0f, 0.0f, 0.0f}, {0.25f, 0.25f} },
	[11] = { { -0.5f, -0.5f, +0.5f }, {0.0f, 0.0f, 0.0f}, {0.25f, 0.50f} },
	[12] = { { +0.5f, -0.5f, +0.5f }, {0.0f, 0.0f, 0.0f}, {0.00f, 0.50f} },
